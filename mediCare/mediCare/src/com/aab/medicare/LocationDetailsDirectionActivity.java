...
public class LocationDetailsDirectionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		namePlace = Utilities.takeIntent.getStringExtra("tempat");
		latitude = Utilities.takeIntent.getDoubleExtra("latitude", 0);
		longitude = Utilities.takeIntent.getDoubleExtra("longitude", 0);
