...
public class CreateAlarmDateActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_create_alarm_date);
		...
		OnClickListener setClickListener = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent("com.aab.medicare.PopUpAlarmDateActivity");
