...
import com.aab.medicare.adapter.LocationAdapter;
import com.aab.medicare.model.LocationModel;
	        ...
	        else
	        {
	        	...
	        	lvLocation.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Intent giveIntent = new Intent(getApplicationContext(), LocationDetailsActivity.class);
