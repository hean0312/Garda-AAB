...
import com.aab.medicare.adapter.LocationDetailsAdapter;
import com.aab.medicare.helper.ConnectionDetector;
import com.aab.medicare.helper.JSONParser;
import com.aab.medicare.helper.Utilities;
import com.aab.medicare.model.LocationDetailsModel;
...
public class LocationDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myChoice = Utilities.takeIntent.getIntExtra("valChoice", 0);
			...
			if (arrPlace != null)
			{
				...
				lvLocDetails.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Utilities.giveIntent = new Intent(LocationDetailsActivity.this, LocationDetailsDirectionActivity.class);
						Utilities.giveIntent.putExtra("tempat", listLocDetails.get(position).getNamePlace());
						Utilities.giveIntent.putExtra("latitude", listLocDetails.get(position).getLatitudePlace());
						Utilities.giveIntent.putExtra("longitude", listLocDetails.get(position).getLongitudePlace());
